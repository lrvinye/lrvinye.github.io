---
title: 通过 Helm 部署 RabbitMQ 集群
date: 2021-04-01 21:41:45
tags: [Helm, K8S, RabbitMQ, Bitnami, 安装, 配置]
category: 运维
---

下面将介绍，在 K8S 集群中通过 Bitnami 的 Helm Chart 搭建部署一个负载均衡架构 3 节点的 RabbitMQ 集群

# 环境

- 腾讯云 kubernetes 1.18.4-tke.6
- Bitnami RabbitMQ-8.11.5 [Chart 下载](https://charts.bitnami.com/bitnami/rabbitmq-8.11.5.tgz)
