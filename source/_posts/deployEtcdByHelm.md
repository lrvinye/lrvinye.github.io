---
title: 通过 Helm 部署 Etcd 集群
date: 2021-04-04 15:01:07
tags: [Helm, K8S, Etcd, Bitnami, 安装, 配置]
category: 运维
---

下面将介绍，在 K8S 集群中通过 Bitnami 的 Helm Chart 搭建部署一个 3 节点架构的 Etcd 集群
...
> 注意，这里踩过一个小坑，如果你之前使用同一个盘作持久化，那么这里的配置会无法生效，还是之前的配置，就可能会导致错误，具体参考[这里](https://github.com/bitnami/charts/issues/2433)

这里我们由于是集群内部使用，不暴露出去，所以关闭认证
